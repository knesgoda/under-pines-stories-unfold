...
-- Create or update the post_reaction_counts view to be a materialized view with triggers
...
INSERT INTO post_reaction_counts (post_id, counts)
SELECT DISTINCT post_id, '{}'::jsonb
FROM posts
WHERE id NOT IN (SELECT post_id FROM post_reaction_counts)
